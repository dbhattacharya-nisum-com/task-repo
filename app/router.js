...
var Router =Marionette.AppRouter.extend({
   ...
   sidePanelView: null,
    ...
    homeRoute: function () {
        this.checkNavBar();
        var homeView=new HomeView({collection: new EmployeeCollection()});
